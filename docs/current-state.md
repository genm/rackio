...
| Linux packaging | Native x86_64/arm64 release archives with independently verified SLSA provenance, HTTPS or client-pushed archive install, checksum verification, hardened systemd unit and preserving/purge uninstaller | No supported immutable public release; reboot and distribution coverage are not proven |
